...
// Get content typed into the input
todoInput.onkeyup = ((e) => {
...
// Mark as uncompleted or unmark completed
...
function render() {
    ...
    if(unCompletedTodos.length > 0) {
        ...
        uncompletedTodosDiv.innerHTML = `<div class='empty'>Relax, you have nothing else to do today...</div>`
    }
...
function createTodoElement(todo) {
    ...
    todoRemoveBtn.href = '#'
    todoRemoveBtn.innerHTML = `<span>❎</span>`
